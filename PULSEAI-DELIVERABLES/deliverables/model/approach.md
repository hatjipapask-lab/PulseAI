...
ValveGuard / PulseAI **model-approach deliverable**. Same document as `model/approach.md`. The Python programs that implement it are listed in `notebooks/README.md` and exercised in `notebooks/02_five_tier_engine.ipynb`.
